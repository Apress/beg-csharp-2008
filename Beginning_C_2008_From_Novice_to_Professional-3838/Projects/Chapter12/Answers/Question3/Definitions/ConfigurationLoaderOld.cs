...
namespace Definitions {
    ...
    // I renamed this class so that I have the old code for reference purposes
    // but it is not in my code
    [Obsolete( "This class should not be used and is only a reference for implementation")]
    public class ConfigurationLoaderOld {
        ...
        static ConfigurationLoaderOld _instance;
        static ConfigurationLoaderOld() {
            _instance = new ConfigurationLoaderOld();
        }
        ConfigurationLoaderOld() {
            _availableTypes = new Dictionary<string, ConfigurationInfo>();
        }

        public static ConfigurationLoaderOld Instance {
            get {
                return _instance;
            }
        }
