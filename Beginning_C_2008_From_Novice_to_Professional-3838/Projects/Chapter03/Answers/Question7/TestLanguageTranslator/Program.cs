...
namespace TestLanguageTranslator {
    ...
    class Program {
        public static string TrimingWhitespace(string buffer) {
            ...
            return LanguageTranslator.Translator.TranslateHello( 
                LanguageTranslator.Translator.EnglishToGerman, trimmed);
        }
        public static string FindSubstring(string buffer) {
            int offset = buffer.IndexOf("allo");
            if (offset != -1) {
                return LanguageTranslator.Translator.TranslateHello(
                    LanguageTranslator.Translator.FrenchToGerman, "allo");
            }
            else {
                return "";
            }
        ...
        static void TestTranslateHello2() {
            ...
            verifyValue = LanguageTranslator.Translator.TranslateHello(
                LanguageTranslator.Translator.EnglishToGerman, "hello");
            ...
            verifyValue = LanguageTranslator.Translator.TranslateHello(
                LanguageTranslator.Translator.FrenchToGerman, "allosss");
