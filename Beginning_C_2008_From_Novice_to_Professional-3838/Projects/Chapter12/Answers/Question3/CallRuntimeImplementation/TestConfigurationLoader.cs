...
namespace CallRuntimeImplementation {
    static class TestConfigurationLoader {
        ...
        public static void TestReferenceDynamicAssemblyLoader() {
            IDefinition cls = DynamicDirectoryLoader.Instance.Instantiate<IDefinition>("SuperCool");
            if (cls == null) {
                Console.WriteLine("Check if your root path configuration item is correct");
            }
            else {
        ...
        public static void RunAll() {
            ...
            TestReferenceDynamicAssemblyLoader();
        }
    }
}
